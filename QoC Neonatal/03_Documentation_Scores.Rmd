...
plot.Demographics %>% ggplot() +
  ...
  demog<-c("Male",
                               ...
                               "Gestational Age",
                               "Birth Weight")
  knitr::kable(demog,"simple",caption="Variables included")
...
plot.Maternal.history %>% ggplot() +
 ...
 knitr::kable(maternal.list,"simple",caption="Variables included")
...
plot.presenting.complains %>% ggplot() +
  ...
  complaints.cardinal.list<-c("Temparature",
     ...
     " Bulging Fontanelle",
      "Floppy")
   knitr::kable(complaints.cardinal.list,"simple",caption="Variables included")
...
other.signs.list<-c("Can Suck or Breastfeed",
   ...
   knitr::kable(other.signs.list,"simple",caption="Variables included")
