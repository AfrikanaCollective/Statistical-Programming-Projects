...
setwd("C:/Users/dchelangat/Downloads/qqq/Statistical-Programming-Projects/QoC Neonatal")
...
Analysis.Dataset<-Analysis.Dataset%>%dplyr::filter(!is.na(After_SENSS_NETS_Drop) & After_SENSS_NETS_Drop == F)
